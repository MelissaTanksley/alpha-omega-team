      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mb-6 bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
          ...
          <div className="border-t border-slate-200 pt-3">
            ...
            <div className="flex flex-wrap gap-2">
               ...
               {results.selectedFrameworks?.mitre_atlas && <span className="text-xs bg-orange-50 border border-orange-200 text-orange-700 px-2.5 py-1 rounded-full font-medium">MITRE ATLAS</span>}
               </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
           <Button onClick={() => {
                ...
                const params = new URLSearchParams({ id: results.id || '', ...(fw.gdpr ? { gdpr: '1' } : {}), ...(fw.nist_rmf === false ? { no_rmf: '1' } : {}), ...(fw.nist_ai_rmf === false ? { no_ai_rmf: '1' } : {}), ...(fw.mitre_atlas === false ? { no_atlas: '1' } : {}), ...(fw.hipaa === false ? { no_hipaa: '1' } : {}), ...(fw.nist_csf === false ? { no_csf: '1' } : {}), ...(fw.iso_27005 === false ? { no_iso: '1' } : {}) });
                ...
                <div className="border-t border-slate-100 pt-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      { key: 'mitre_atlas', label: 'MITRE ATLAS', desc: 'Adversarial Threat Landscape for AI Systems — tactics & techniques against ML models', checkedCard: 'border-orange-300 bg-orange-50', checkedBox: 'bg-orange-600 border-orange-600' },
