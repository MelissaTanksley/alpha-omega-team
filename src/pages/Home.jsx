...
export default function Home() {
  useEffect(() => { document.title = 'AI Risk Navigator for Healthcare'; }, []);
  ...
  return (
    <div>
      ...
      <section className="bg-slate-900 text-white relative overflow-hidden">
        ...
        {/* Fade overlay to blend compass into background */}
        <div className="absolute inset-0 pointer-events-none" style={{
          background: 'linear-gradient(to bottom, rgba(15,23,42,0) 0%, rgba(15,23,42,0.5) 40%, rgba(15,23,42,1) 100%)',
        }} />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 max-w-xl mx-auto text-sm">
              View an example assessment or jump straight into a live demo report.
            </p>
          </div>
      ...
      <section id="request-demo" className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-4">
            <Link to="/RiskAssessment">
              <Button size="sm" variant="outline" className="border-white/40 bg-transparent text-white/80 hover:bg-white/10 hover:text-white px-6">
                Start Assessing Now
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
