  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-lg">
      ...
      <div className="bg-slate-900 px-8 py-8">
        ...
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-slate-400 text-xs font-medium tracking-wide uppercase">for Healthcare</span>
            </div>
        ...
        <div className={`flex items-center gap-5 bg-slate-800 rounded-xl px-6 py-5 ring-2 ${overallSt.ring} shadow-xl ${overallSt.glow} border-l-4 border-teal-500`}>
          <div>
            <p className="text-xs text-teal-400 uppercase tracking-widest mb-2 font-bold">Overall Risk Level</p>
            <span className={`inline-block px-6 py-2.5 rounded-xl text-3xl font-extrabold tracking-wide ${overallSt.bg} ${overallSt.text}`}>
              {overall.toUpperCase()}
            </span>
          </div>
        ...
        <div className="border-t border-slate-200 pt-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <p className="text-sm font-semibold text-slate-600">
              Generated by <span className="text-teal-600">AI Risk Navigator</span> — aligned with ISO 27005, HIPAA, and NIST CSF 2.0
            </p>
          </div>
          <div className="flex items-center justify-between flex-wrap gap-3">
            <p className="text-xs text-slate-400">
              This report is intended for governance and risk management purposes only.
            </p>
